...
public class EndlessTerrain : MonoBehaviour
{
    ...
    public const float viewerMoveThresholdForChinkUpdate = 25f;
    public const float sqrViewerMoveThresholdForChinkUpdate = viewerMoveThresholdForChinkUpdate * viewerMoveThresholdForChinkUpdate;
